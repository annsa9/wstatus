...
export class MyApp {
  ...
  insertData(db){
    db.sqlBatch(["INSERT INTO w_category values('Status')",
      "INSERT INTO w_category values('Shayari')",
      "INSERT INTO w_category values('Jokes')",
      "INSERT INTO w_category values('Quotes')",
      "INSERT INTO w_category values('Group Links')"], {})
      .then(() => {
