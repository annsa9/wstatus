...
export class MyApp {
    ...
    this.sqlite.create({
      ...
      .then((db: SQLiteObject) => {
       ...
       this.showAlert('db created');
        db.executeSql('create table if not exists w_category(cat_id INTEGER PRIMARY KEY,catogory VARCHAR(32))', {})
          .then(() => {
  ...
  insertData(db){
    db.sqlBatch(["INSERT INTO w_category values(1,'Status')",
      "INSERT INTO w_category values(2,'Shayari')",
      "INSERT INTO w_category values(3,'Jokes')",
      "INSERT INTO w_category values(4,'Quotes')",
      "INSERT INTO w_category values(5,'Group Links')"])
      .then(() => {
